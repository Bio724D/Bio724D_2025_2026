...
* [poem-corpus.zip](https://raw.githubusercontent.com/Bio724D/Bio724D_2024_2025/refs/heads/main/data/poem-corpus.zip)
...
1. Write a for-loop to read each of the files in the `poems_corpus` directory, returning four character vectors containing:  (1) the authors first names; (2) authors last names; (3) poem/song title; (4) text of the poem/song
