...
Comment: All biologically interesting; let's take a stab at envisioning how we might exploit computing to help us tackle these problems.
...
## Mockup of the "driver" script


```
parallel --colsep ',' --header 1 `get_sequences.sh` :::: gene_list.csv
