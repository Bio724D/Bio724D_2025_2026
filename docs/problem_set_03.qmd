...
6. Use the [patchwork library](https://patchwork.data-imaginist.com/) to combine the following four plots into a single 2 x 2 grid of plots, with labels A to D.
