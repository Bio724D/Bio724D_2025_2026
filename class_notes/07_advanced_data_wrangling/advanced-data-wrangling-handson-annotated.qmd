...
![Growth curves, Final figure](./microbial-growth-curves-final.png)
...
* We could use the [lubridate](https://lubridate.tidyverse.org/) library that is designed to work with time, date, and duration information to do the conversion for us.  This second option is preferable, as lubridate has convenient features like the ability to convert between different time units automatically.
